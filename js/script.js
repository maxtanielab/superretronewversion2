...
const urlMap = "./region.geojson",
	urlDepartments = "./departemnts.geojson";
			...
			var departments = L.geoJSON(countiesDepartments.responseJSON, {
				filter: function (feature, layer) {
					...
					if (
						...
						// 		<i class="qualification">${qualification}</i>
						// 		<p class="adress">${adress}</p>
						// 		<a href="${url}" target="_blank" class="see-shop">Page infossssssssssss <i class="fa-solid fa-chevron-right fa-size"></i></a>
					 	// 		</div>`;
						// 	$(".grid-content .info-panel .marker-rich-infos").html(output);
						// }
					}
